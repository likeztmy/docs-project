    ...
    <div className="flex items-center gap-x-0.5">
      ...
      {isEditing ? (
        ...
        <button
          ...
          className="h-7 w-10 text-sm text-center border border-neutral-400 rounded-sm hover:bg-neutral-200/80 bg-transparent cursor-text"
        >
          {currentFontSize}
        </button>
      )}
          ...
          <button
            ...
            className={cn(
              ...
              (value === 0 && !editor?.isActive("heading")) ||
                (editor?.isActive("heading") && "bg-neutral-200/80"),
            )}
            style={{ fontSize }}
          >
            {label}
...
export const Toolbar = () => {
  ...
  return (
    <div className="bg-[#F1F4F9] px-2.5 py-0.5 rounded-[24px] min-h-[40px] flex items-center gap-x-1">
      {sections[0].map((item) => (
